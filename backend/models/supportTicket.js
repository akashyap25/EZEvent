...
const supportTicketSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['technical', 'billing', 'feature', 'bug', 'account', 'event', 'payment', 'general', 'other'],
    default: 'other'
  },
  priority: {
    type: String,
...
// Generate ticket number (pre-validate so it's set before required check)
...
// Indexes (ticketNumber index already created by unique: true in schema)
